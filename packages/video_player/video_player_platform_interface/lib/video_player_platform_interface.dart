...
abstract class VideoPlayerPlatform {
  ...
  /// Sets the speed to a range between 0.0 and 2.0.
  Future<void> setSpeed(int textureId, double speed) {
    throw UnimplementedError('setSpeed() has not been implemented.');
  }

  /// Clips the video between startMs and endMs.
  /// If startMs is < 0 or endMs is >= clip duration in ms
  /// The result is undefined
  Future<void> clip(int textureId, int startMs, int endMs) {
    throw UnimplementedError('clip() has not been implemented.');
  }
