...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  /// Returns true when the Video Player has been or is in process of being disposed. False otherwise
  ...
  Future<void> _applySpeed() async {
    ...
    VideoPlayerPlatform.instance.setSpeed(_textureId, value.speed);
  }
  ...
  Future<void> clip(int startMs, int endMs) async {
    ...
    VideoPlayerPlatform.instance.clip(_textureId, startMs, endMs);
  }
