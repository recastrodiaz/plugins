...
public class Messages {
  ...
  public static class ClipMessage {
    ...
    public void setStartMs(Long setterArg) { this.startMs = setterArg; }

    private Long endMs;
    public Long getEndMs() { return endMs; }
    public void setEndMs(Long setterArg) { this.endMs = setterArg; }

    HashMap toMap() {
      HashMap<String, Object> toMapResult = new HashMap<String, Object>();
      toMapResult.put("textureId", textureId);
      toMapResult.put("startMs", startMs);
      toMapResult.put("endMs", endMs);
      return toMapResult;
    }
    static ClipMessage fromMap(HashMap map) {
      ClipMessage fromMapResult = new ClipMessage();
      fromMapResult.textureId = (map.get("textureId") instanceof Integer) ? (Integer)map.get("textureId") : (Long)map.get("textureId");
      fromMapResult.startMs = (map.get("startMs") instanceof Integer) ? (Integer)map.get("startMs") : (Long)map.get("startMs");
      fromMapResult.endMs = (map.get("endMs") instanceof Integer) ? (Integer)map.get("endMs") : (Long)map.get("endMs");
      return fromMapResult;
    }
  }
  ...
  public interface VideoPlayerApi {
    ...
    public static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<Object>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.clip", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler(new BasicMessageChannel.MessageHandler<Object>() {
            public void onMessage(Object message, BasicMessageChannel.Reply<Object> reply) {
              ClipMessage input = ClipMessage.fromMap((HashMap)message);
              HashMap<String, HashMap> wrapped = new HashMap<String, HashMap>();
              try {
                api.clip(input);
                wrapped.put("result", null);
