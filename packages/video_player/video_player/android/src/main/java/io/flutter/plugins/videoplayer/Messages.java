...
public class Messages {
  ...
  public static class ClipMessage {
    ...
    public void setStartMs(Long setterArg) {
      this.startMs = setterArg;
    }
    ...
    public void setEndMs(Long setterArg) {
      this.endMs = setterArg;
    }
    ...
    static ClipMessage fromMap(HashMap map) {
      ...
      fromMapResult.textureId =
          (map.get("textureId") instanceof Integer)
              ? (Integer) map.get("textureId")
              : (Long) map.get("textureId");
      fromMapResult.startMs =
          (map.get("startMs") instanceof Integer)
              ? (Integer) map.get("startMs")
              : (Long) map.get("startMs");
      fromMapResult.endMs =
          (map.get("endMs") instanceof Integer)
              ? (Integer) map.get("endMs")
              : (Long) map.get("endMs");
      return fromMapResult;
    }
  }
    ...
    public static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<Object>(
                binaryMessenger,
                "dev.flutter.pigeon.VideoPlayerApi.clip",
                new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler(
              new BasicMessageChannel.MessageHandler<Object>() {
